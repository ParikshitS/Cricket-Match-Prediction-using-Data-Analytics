...
mypath = "./odis/"
mypath = "C:/CSCourses/CSCI 720 Big Data Analytics/Group Project/odis/"
...
team1 = input('Country as India/Australia/England')
team2 = input('Country as Sri Lanka/Australia/England')
...
def classify_2ndInng(team_total, wickets):
    if wickets >= 8:
        wicketsgte8_2.append(1)
        wickets5t7_2.append(0)
        wickets1t4_2.append(0)
        wickets0_2.append(0)
    elif wickets >=5 and wickets < 8:
        wicketsgte8_2.append(0)
        wickets5t7_2.append(1)
        wickets1t4_2.append(0)
        wickets0_2.append(0)
    elif wickets >= 1 and wickets < 5:
        wicketsgte8_2.append(0)
        wickets5t7_2.append(0)
        wickets1t4_2.append(1)
        wickets0_2.append(0)
    else:
        wicketsgte8_2.append(0)
        wickets5t7_2.append(0)
    ...
    if team_total >= 300:
        runs_gte300_2.append(1)
        runs_250to299_2.append(0)
        runs_200to249_2.append(0)
        runs_lt200_2.append(1)
    elif team_total >= 250 and team_total < 300:
        runs_250to299_2.append(1)
        runs_gte300_2.append(0)
        runs_200to249_2.append(0)
        runs_lt200_2.append(0)

    elif team_total >= 200 and team_total < 250:
        runs_200to249_2.append(1)
        runs_gte300_2.append(0)
        runs_250to299_2.append(0)
        runs_lt200_2.append(0)
    else:
    ...
    for file in files:
        if file.endswith(".yaml") and file in my_Set:
            ...
            if team1 in s:
                ...
                if (twinner == team1 and toss == 'field') or (twinner != team2 and toss == 'bat'):
                    keys = []
                    for key in d['info']['outcome']:
                        keys.append(key)
                    if twinner == team1:
                    ...
                    if key in 'result':
                        ...
                        #                 except KeyError:
                        #                     pass
                        #                 classify_2ndInng(team_total, wickets)
                        #
                        # except IndexError:
...
features = np.array([gte300, btw1_200, btw200_250, btw250_299, gte8, btw5_7, btw1_4, w0])
class_label_X = np.array(india_win)
print(features)
class_label_X = class_label_X.reshape((class_label_X.shape[0], 1))
print(class_label_X.shape)
...
print(wicketsgte8);print(wickets5t7);print(wickets1t4);print(wickets0)
c1= 0
c2 = 0
total = 0
no_outcome = 0
...
features_y = np.array([gte300, btw1_200, btw200_250, btw250_299, gte8, btw5_7, btw1_4, w0])
class_label_Y = np.array(india_win)
print('feature y', features_y)
...
model.fit(features, class_label_X, epochs=2000, batch_size=10)
